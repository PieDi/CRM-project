<template>
  <div class="bbb">
    <div class="basic">
      ...
      <div class="header">
        ...
        <div
          ...
          :style="{ color: '#007AFF' }"
          @click="() => {
          scanFJAction(2, diseaseObject.diseaseBasic.id as number)
        }"
          >查看附件</div
        >
      </div>
              ...
              <div class="block-content" :style="{ background: '#F5F8FC' }">
                ...
                <div class="content-label">
                  ...
                  <div
                    ...
                    :style="{ color: '#007AFF' }"
                    @click="() => {
                    scanFJAction(3, item.id as number)
                  }"
                    >查看附件</div
                  >
                </div>
              ...
              <div class="block-content" :style="{ background: '#F5FCFB' }">
                ...
                <div class="content-label">
                  ...
                  <div
                    ...
                    :style="{ color: '#007AFF' }"
                    @click="() => {
                    scanFJAction(4, item.id as number)
                  }"
                    >查看附件</div
                  >
                </div>
              ...
              <div class="block-content" :style="{ background: '#FAF5FC' }">
                ...
                <div class="content-label">
                  ...
                  <div
                    ...
                    :style="{ color: '#007AFF' }"
                    @click="() => {
                    scanFJAction(5, item.id as number)
                  }"
                    >查看附件</div
                  >
                </div>
              ...
              <div class="block-content" :style="{ background: '#FCF9F5' }">
                ...
                <div class="content-label">
                  ...
                  <div
                    ...
                    :style="{ color: '#007AFF' }"
                    @click="() => {
                    scanFJAction(6, item.id as number)
                  }"
                    >查看附件</div
                  >
                </div>
    ...
    <e1-record
      v-if="eRecordDrawerInfo.visible"
    ...
    <i1-record
      v-if="iRecordDrawerInfo.visible"
    ...
    <c1-record
      v-if="cRecordDrawerInfo.visible"
